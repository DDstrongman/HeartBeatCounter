...
#import "HealthMeasureViewController.h"


@interface HealthMeasureViewController ()

@end

@implementation HealthMeasureViewController

- (void)viewDidLoad
{
    [super viewDidLoad];
    self.navigationItem.title=NSLocalizedString(@"cellTitle3", @"");
    ...
    myLbl.text = NSLocalizedString(@"healthMainText", @"");
